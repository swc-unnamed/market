...
/**
  ...
  /**
   * `prisma.liveAuctionSetting`: Exposes CRUD operations for the **LiveAuctionSetting** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more LiveAuctionSettings
    * const liveAuctionSettings = await prisma.liveAuctionSetting.findMany()
    * ```
    */
  get liveAuctionSetting(): Prisma.LiveAuctionSettingDelegate<ExtArgs, ClientOptions>;
